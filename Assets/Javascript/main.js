...
//Uses the weather data and then gives a five day forecast
function getWeatherToday() {
	...
	$.ajax({
		...
		$.ajax({
            ...
            //UV index which is according to chart severity the result is then based on a colour
			if (uvi >= 0 && uvi <= 2) {
